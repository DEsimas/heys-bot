...
export class BooruSender {
    ...
    private sendPosts(posts: SearchResults): void {
        ...
        posts.forEach((el, index) => {
            if(this.isVideo(el.fileUrl)) this.message.channel.send(el.fileUrl || "https://cdn.discordapp.com/attachments/883231507349663754/919280306039693362/de87d8677c229687.png");
        ...
        if(this.amount >= 5) this.message.channel.send(this.message.url);
    };
